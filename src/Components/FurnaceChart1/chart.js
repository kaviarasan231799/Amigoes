...
return(
    <div className='chart-container'>
      ...
      <h1>Furance1</h1>
     <div className="chart-inside-container">
      <h1 className='chart-head'>Temperature</h1>
       <Line
        data={furnace_data1}
        options = {furnace_options1}
       ></Line>
     </div>

     <div className="chart-inside-container-2">
